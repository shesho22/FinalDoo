...
public final class EliminarRutinaValidator implements Validator<RutinaDomain>{

	private static final Validator<RutinaDomain> instancia = new EliminarRutinaValidator();

    private EliminarRutinaValidator() {
        super();
    }
