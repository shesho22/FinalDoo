...
public class EliminarEjercicioValidator implements Validator<EjercicioDomain>{
    private static final Validator<EjercicioDomain> instancia = new EliminarEjercicioValidator();

    private EliminarEjercicioValidator() {
        super();
    }
