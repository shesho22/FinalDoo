...
public class ModificarEjercicioValidator implements Validator<EjercicioDomain>{
    private static final Validator<EjercicioDomain> instancia = new ModificarEjercicioValidator();

    private ModificarEjercicioValidator() {
        super();
    }
